#!/bin/bash
PATH_TO_DIR="/etc/gostminer/"
BIN_NAME="gostminer"
PATH_TO_BIN=${PATH_TO_DIR}${BIN_NAME}
SERVICE_NAME=${BIN_NAME}
DOWNLOAD_ADDR="https://github.com/blockchiansea/Gost-Miner/raw/main/releases/gostminer.tar.gz"
case $1 in
install)
	...
	echo "install done, please open the URL to login, http://$IP:2356 , password is: 123456"
	;;
update)
	if [ -f ${PATH_TO_BIN} ]; then
